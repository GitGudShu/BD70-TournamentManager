...
CREATE PROCEDURE CreateSequentialTournamentsWithPlayers(
...
CREATE PROCEDURE CreateSequentialTournamentsWithTeams(
    IN p_tournament_count INT
)
BEGIN
    -- Declare variables
...
-- CALL CreateSequentialTournamentsWithPlayers(5);
-- CALL CreateSequentialTournamentsWithTeams(5);
